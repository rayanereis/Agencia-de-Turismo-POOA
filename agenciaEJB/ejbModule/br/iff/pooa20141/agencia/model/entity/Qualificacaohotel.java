...
/**
 * The persistent class for the qualificacaohotel database table.
 * 
 */
@Entity
@NamedQuery(name="Qualificacaohotel.findAll", query="SELECT q FROM Qualificacaohotel q")
public class Qualificacaohotel implements Serializable {
